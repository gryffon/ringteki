...
describe('Costs.payReduceableFateCost', function() {
    beforeEach(function() {
        ...
        this.playerSpy = jasmine.createSpyObj('player', ['getDuplicateInPlay', 'getReducedCost', 'markUsedReducers', 'allowGameAction']);
        this.playerSpy.allowGameAction.and.returnValue(true);
