describe('Monastery Protector', function() {
    integration(function() {
        beforeEach(function() {
            this.setupTest({
                ...
                player2: {
                    ...
                    hand: ['way-of-the-scorpion', 'hurricane-punch', 'duelist-training', 'unfulfilled-duty', 'jade-tetsubo', 'court-games', 'civil-discourse'],
        ...
        // it('should allow targeting if your event costs negative fate', function() {
        //     this.noMoreActions();
        //     this.initiateConflict({
        ...
        it('should not allow targeting if you cannot pay a fate (opponent chooses targets)', function() {
            this.player1.fate = 10;
            this.player2.fate = 1;
            this.noMoreActions();
            this.initiateConflict({
