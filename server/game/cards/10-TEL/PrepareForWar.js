            ...
            target: {
                ...
                gameAction: AbilityDsl.actions.multiple([
                    AbilityDsl.actions.selectCard(context => ({
                        ...
                        messageArgs: cards => [context.player, cards.length === 0 ? 'nothing' : cards, context.target]
                    })),
                    ...
                    AbilityDsl.actions.honor(context => ({ target: context.target.hasTrait('commander') ? context.target : [] }))
                ])
            }
        })
    }
