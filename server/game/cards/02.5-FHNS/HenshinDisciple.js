...
class HenshinDisciple extends DrawCard {
    setupCardAbilities(ability) {
        this.persistentEffect({
            condition: () => (
                this.game.rings['air'].claimed && this.game.rings.air.isClaimed(this.controller)) || 
        ...
        this.persistentEffect({
            condition: () => (
                this.game.rings['earth'].claimed && this.game.rings.earth.isClaimed(this.controller)) || 
        ...
        this.persistentEffect({
            condition: () => (
                this.game.rings['fire'].claimed && this.game.rings.fire.isClaimed(this.controller)) || 
