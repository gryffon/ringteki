...
const EffectBuilder = {
    card: {
        ...
        flexible: (type, value) => _.isFunction(type, value) ? EffectBuilder.card.dynamic(type, value) : EffectBuilder.card.static(type, value)
    },
    player: {
        ...
        flexible: (type, value) => _.isFunction(type, value) ? EffectBuilder.player.dynamic(type, value) : EffectBuilder.player.static(type, value)
    },
    conflict: {
        ...
        flexible: (type, value) => _.isFunction(type, value) ? EffectBuilder.conflict.dynamic(type, value) : EffectBuilder.conflict.static(type, value)
    },
    ring: {
        ...
        flexible: (type, value) => _.isFunction(type, value) ? EffectBuilder.ring.dynamic(type, value) : EffectBuilder.ring.static(type, value)
    }
};
