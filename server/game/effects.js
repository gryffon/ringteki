...
const Effects = {
    ...
    modifyDuelBaseMilitarySkill: (value) => EffectBuilder.card.static(EffectNames.ModifyDuelBaseMilitarySkill, value),
    modifyDuelBasePoliticalSkill: (value) => EffectBuilder.card.static(EffectNames.ModifyDuelBasePoliticalSkill, value),
