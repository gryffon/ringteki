        ...
        return (
            <div className='col-xs-12 full-height'>
                ...
                <div className='panel about-container'>
                    ...
                    <h3>FiveRingsDB</h3>
                    <p>Link: <a href='https://fiveringsdb.com//' target='_blank' rel='noopener noreferrer'>FiveRingsDB</a></p>
                    ...
                    <h3>Troll5R</h3>
                    <p>Link: <a href='https://www.facebook.com/Troll5R/' target='_blank' rel='noopener noreferrer'>Troll5R</a></p>
                    ...
                    <p>Link: <a href='http://thelotuspavilion.com/' target='_blank' rel='noopener noreferrer'>The Lotus Pavilion</a></p>
