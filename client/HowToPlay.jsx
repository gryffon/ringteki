        ...
        return (
            <div className='col-xs-12 full-height'>
                ...
                <div className='panel about-container'>
                    <a className='btn btn-danger btn-lg pull-right' target='_blank' href='https://github.com/gryffon/ringteki/issues' rel='noopener noreferrer'>Report Problems</a>

                    <p>This guide is aimed at players familiar with the Legend of the Five Rings: The Card Game who want to start playing online using the Jigoku Online platform. If you are new to this cardgame in general, there is a <a href='https://www.youtube.com/watch?v=wTtjYzq4T54' target='_blank' rel='noopener noreferrer'>helpful tutorial video</a>, a <a href='https://images-cdn.fantasyflightgames.com/filer_public/74/46/7446c964-613e-4c01-8902-199257c5d4af/l5c01_learntoplay_web.pdf' target='_blank' rel='noopener noreferrer'>Learn To Play guide</a>, and a <a href='https://fiveringsdb.com/rules/reference' target='_blank' rel='noopener noreferrer'>Rules Reference Guide</a> to help you out.</p>
                    ...
                    <p>While Jigoku Online is still a work in progress and the vast majority of cards are not currently implemented. We try to keep a list up to date with the current state of the automation which can be found <a target='_blank' href='https://docs.google.com/spreadsheets/d/1YTfjJyIfytvvQWpAsx_szP3rRwbRMpNXtivQJtA5g3o/edit?usp=sharing' rel='noopener noreferrer'>here</a>. If you happen upon a card that you believe is not working as it should and it is not on that list, it would help immensely if you would submit an issue on <a target='_blank' href='https://github.com/gryffon/ringteki/issues' rel='noopener noreferrer'>GitHub</a>. Other comments and/or feedback can be left on GitHub as well.</p>
