        ...
        return (
            <div className='col-xs-12 full-height'>
                ...
                <div className='panel about-container'>
                    <a className='btn btn-danger btn-lg pull-right' target='_blank' rel='noopener noreferrer' href='https://github.com/gryffon/ringteki/issues'>Report Problems</a>
                    <h3>What is this?</h3>
                    ...
                    <p>This is handled by the good people at <a href='http://gravatar.com' rel='noopener noreferrer' target='_blank'>Gravatar</a>.  Sign up there with the same email address you did there and it should appear on the site after a short while.
                It will also use the avatar on any site that uses gravatar.  Examples include github and jinteki.</p>
                    ...
                    <p>The background of the site is by an artist named <a href='https://speeh.deviantart.com/' target='_blank' rel='noopener noreferrer'>Speeh</a> and can be found <a href='https://speeh.deviantart.com/art/L5R-Fu-Leng-575822238' target='_blank' rel='noopener noreferrer'>here</a>.</p>
                    <p>The in game backgrounds are by <a href='https://alayna.deviantart.com/' target='_blank' rel='noopener noreferrer'>Alayna Lemmer-Danner</a>.  She&apos;s very talented, you should check out her work!</p>
                    <p>The tokens used for Spirit of the River are by <a href='https://www.dojocreativedesign.com/l5r-cardgame' target='_blank' rel='noopener noreferrer'>David Robotham</a>.  He has a selection of L5R related merchandise, check it out <a href='https://www.dojocreativedesign.com/shop' target='_blank' rel='noopener noreferrer'>here</a>.</p>
                    ...
                    <p>Sure!  The project is all written in Javascript.  The server is node.js and the client is React.js.  The source code can be found in the&nbsp;
                        <a target='_blank' rel='noopener noreferrer' href='http://github.com/gryffon/ringteki'>GitHub Repository</a>.  Check out the code and instructions on there on how to get started and hack away!  See the card implementation
                status list above to have a look at what needs to be done.  If you want to join the dev discord, there&apos;s a link on the <Link href='/community'>Community</Link> page.
                    ...
                    <p>You can use this link: <a target='_blank' href='https://paypal.me/ringteki' rel='noopener noreferrer'>Paypal</a> to donate to the project. Note: The account uses my name, but is completely separate from my personal Paypal account.</p>
